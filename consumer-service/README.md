...
mvn -f consumer-service/pom.xml spring-boot:run \
  -Dspring-boot.run.arguments="--studyrooms.consumer.enabled=true --studyrooms.consumer.base-url=http://localhost:8080 --studyrooms.consumer.username=student --studyrooms.consumer.password=student123"
```
